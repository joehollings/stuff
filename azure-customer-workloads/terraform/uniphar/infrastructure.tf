...
module "ppg" {
  source                         = "github.com/OpalwaveSolutions/terraform-azure-proximity-placement-group"
...
module "dc_cc" {
  source              = "github.com/OpalwaveSolutions/terraform-azure-windows-dc-cc?ref=v1.1.0"
...
module "network" {
  source                      = "github.com/OpalwaveSolutions/terraform-azure-network?ref=v1.2.0"
...
# module "network" {
#   source                      = "github.com/OpalwaveSolutions/terraform-azure-network-vpn"
#   for_each                    = local.virtual_networks
#   virtual_network_name        = "10${local.customer_number}-vnet-app-${each.key}"
#   location                    = azurerm_resource_group.prod.location
#   resource_group_name         = azurerm_resource_group.prod.name
