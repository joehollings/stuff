...
Install-ADDSDomain -Credential $psCred -ParentDomainName "owscs.local" -NewDomainName $Domain -DomainMode "7" -DomainType TreeDomain -SafeModeAdministratorPassword $safemodepassword -NoRebootOnCompletion