...
$SetupFile = "WinSCP-6.1.2-Setup.exe"
$MediaPath = "https://owscsafs01.file.core.windows.net/nas/WinSCP/$SetupFile"
# Time in seconds the script waits for media to copy
$MediaCopyWait = "10"
$InstallLocation = "C:\Program Files (x86)\WinSCP"
$Destination = "C:\Windows\Temp\WinSCP\$SetupFile"
$unattendedArgs = '/SILENT /ALLUSERS /NORESTART'
...
if ($TestPath1 -eq $false){
    ...
    $Destination = "C:\Windows\Temp\WinSCP\"
