...
$Vendor = "SAP"
$Product = "EPM"
$PackageName = "EPMSP34P2"
$Version = "SP34 Patch 2"
$LogPS = "${env:SystemRoot}" + "\Temp\$Vendor $Product $PackageName $Version PS Wrapper.log"
$MediaPath = "\\NCLMGTNAS01.mgmt.local\media\SAP\EPM\EPMEXCLCLNT34P_2-10011004"
# Time in seconds the script waits for media to copy
$MediaCopyWait = "5"
$InstallLocation = "C:\Program Files (x86)\SAP BusinessObjects\EPM Add-In"
$Destination = "C:\Windows\Temp\EPMSP34\"
$SetupFile = "EPM_Add-in_x32.exe"
$unattendedArgs = '/S /v"SETUPPHASE=Install CT_PROFILE=BPCNW /qn"'
