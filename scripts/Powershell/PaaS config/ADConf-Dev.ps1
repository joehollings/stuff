...
$ServerName = "NCL10015WDC01"
#Enter the tenant FQDN ie Domain.local.
$DomainName = "Howden.local"
...
Copy-GPO -SourceName "NetWeaver Admins" -SourceDomain $SourceDomain -TargetName "NetWeaver Admins" -TargetDomain $TargetDomain
