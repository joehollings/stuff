...
$date = Get-Date -format "dd.MM.yyyy"
        ...
        $ExcelWorkSheet.Range(“B1”) = "Instance Type"
        $ExcelWorkSheet.Range(“C1”) = "AZ"
        $ExcelWorkSheet.Range(“D1”) = "AZ Code"
                ...
                foreach ($customer in $customers)
                {
                    ...
                    ## Loop for each
                            Foreach ($VM in $VMs) {
                                    ...
                                    $ExcelWorkSheet.Range(“B"+$i) = [string]$VM.InstanceType.Value
                                    $ExcelWorkSheet.Range(“C"+$i) = [string]$vm.placement.AvailabilityZone
                                    $ExcelWorkSheet.Range(“D"+$i) = [string]$azdetails.ZoneId
                                    $ExcelWorkSheet.Range(“E"+$i) = [string]$accountid
