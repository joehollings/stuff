...
$Vendor = "Microsoft"
$Product = "Visual Studio 2010 Tools for Office"
$PackageName = "VSTOR"
$Version = "2010"
$LogPS = "${env:SystemRoot}" + "\Temp\$Vendor $Product $PackageName $Version PS Wrapper.log"
$MediaPath = "\\NCLMGTNAS01.mgmt.local\Media\Microsoft\VSTOR"
# Time in seconds the script waits for media to copy
$MediaCopyWait = "5"
$InstallLocation = "HKLM:\SOFTWARE\WOW6432Node\Microsoft\VSTO Runtime Setup\v4\Install"
$Destination = "C:\Windows\Temp\VSTOR\"
$SetupFile = "vstor_redist.exe"
$unattendedArgs = '/q'
